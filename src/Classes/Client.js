...
module.exports = class Client extends Discord.Client {
    ...
    constructors = {
        ...
        mstring: (...string) => string?.filter(s => typeof (s) == "string").join(" ") ?? null,
        ...
        boolean: string => !["false", "0", "0n", "null", "undefined", "NaN", "", "no", "off", null, undefined].includes(string),
        bool: string => !["false", "0", "0n", "null", "undefined", "NaN", "", "no", "off", null, undefined].includes(string),
        color: string => Discord.Util.resolveColor(string),
        guild: string => this.guilds.cache.get(string),
        member: async (string, message) => message?.guild?.member(await resolveUser(this, string)) ?? null,
