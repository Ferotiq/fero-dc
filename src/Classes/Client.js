...
module.exports = class Client extends Discord.Client {
    ...
    constructors = {
        ...
        boolean: string => ["false", "0", "0n", "null", "undefined", "NaN", "", "no", "off", null, undefined].includes(string) ? false : true,
        bool: string => ["false", "0", "0n", "null", "undefined", "NaN", "", "no", "off", null, undefined].includes(string) ? false : true,
